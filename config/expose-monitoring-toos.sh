...
curl -i -X POST \
  --url http://localhost:8001/services/grafana-service/routes/ \
...
curl -i -X POST \
  --url http://localhost:8001/services/kibana-service/routes/ \
...
curl -i -X POST \
  --url http://localhost:8001/services/prometheus-service/routes/ \
